# flake8: noqa
"""
Django settings for pcnet project.
...
WSGI_APPLICATION = 'pcnet.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///pcnet'),
}
